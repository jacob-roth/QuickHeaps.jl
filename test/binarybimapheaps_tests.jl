module TestingBinaryBimapHeaps
...
using QuickHeaps
using QuickHeaps:
    AbstractBinaryBimapHeap, FastBinaryBimapHeap,
...
#=
orientation(::Any) = 0
orientation(h::AbstractBinaryBimapHeap) = orientation(typeof(h))
orientation(::Type{<:AbstractBinaryBimapHeap{T,O}}) where {T,O} = orientation(O)
...
# for A = A1 or A2 and i ≥ 3. These arrays where randomly generated by
# something like:
#     A1 = rand(1:15, 16)
